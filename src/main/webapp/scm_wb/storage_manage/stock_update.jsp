...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Frameset//EN" "http://www.w3.org/TR/html4/frameset.dtd">
	<html>
		<head>
			...
			<script src="/SCM/scm_wb/storage_manage/js/stock_update.js" type="text/javascript" charset="UTF-8"></script>
	</head>
	<body>
		<table style="width:100%;border:0;cellpadding:0;cellspacing:0;">
		  <tr>
		    <td nowrap class="title1">你的位置：工作台面--仓储管理--库存盘点</td>
		  </tr>
		</table>
					...
					<c:forEach items="${sessionScope.productList }" var="product" >
							<table id="headTable" class="a1" style="width:100%;border:0;align:center;">
								<tr align="justify">
				    				...
				    				<td>变化数量<input type="text" id="num" /></td>
				    				<td>类型
				    					<select id="type">
				    						<option>损耗</option>
				    						<option>盘余</option>
				    				...
				    				<td>损益原因<input type="text" id="reason"/></td>
				    				<td><button onclick="stock_update(this)">库存更新</button></td>
				  				</tr>
				  				<tr align="justify">
